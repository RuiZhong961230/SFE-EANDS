...
if __name__ == '__main__':
    if os.path.exists('./SFE_MLP_Data/Acc') == False:
        os.makedirs('./SFE_MLP_Data/Acc')
    if os.path.exists('./SFE_MLP_Data/Scale') == False:
        os.makedirs('./SFE_MLP_Data/Scale')
    """
    ...
    for dataset in Datasets:
        ...
        np.savetxt('./SFE_MLP_Data/Acc/{}.csv'.format(dataset), Acc_trial.T, delimiter=",")
        np.savetxt('./SFE_MLP_Data/Scale/{}.csv'.format(dataset), Sub_trial.T, delimiter=",")
